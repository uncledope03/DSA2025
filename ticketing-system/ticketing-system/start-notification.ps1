...
Write-Host "Changing to notification-service directory..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host "Error starting notification service: $_" -ForegroundColor Red
...
Write-Host "Notification Service stopped." -ForegroundColor Red
Set-Location "C:\ticketing-system"