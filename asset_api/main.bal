...
// In-memory database (assetTag -> Asset)
map<Asset> assetDB = {};

// Create CORS response function
...
service /assets on new http:Listener(8080) {
    ...
    // Handle CORS preflight requests for specific resources
    resource function options [string assetTag]() returns http:Response {
        return createCorsResponse();
    }

    // Handle CORS preflight requests for faculty endpoint
